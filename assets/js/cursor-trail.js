// Snake-style teal cursor trail — desktop only (requires #cursor-ring and #cursor-dot in DOM)
document.addEventListener('DOMContentLoaded', () => {
  ...
  const enlarge = () => {
    ...
    sizeBoost = 2; updateSegmentSizes();
  };
  const reset = () => {
    ...
    sizeBoost = 0; updateSegmentSizes();
  };
  const hide = () => {
  ...
  window.addEventListener('mousedown', () => { ring.style.transform = 'translate(-50%,-50%) scale(0.88)'; });
